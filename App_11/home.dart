...
class _HomeState extends State<Home> {
        ...
        children:<Widget>[
          Column(
              ...
              children: <Widget>[
                ...
                pad(row(
                    pad(db(sex, <String>['Não Informado', 'Masculino', 'Feminino', 'Não Binario'],
                ...
                pad(row(txt('Limite:', 17.5, Colors.black, FontWeight.w500),Container(
                    width: 150, child:sld())),10,10,0,0),
                row(pad(txt('Nacionalidade Brasileiro', 20, Colors.black, FontWeight.normal),0,0,10,0), swt()),
                but(context)
              ]
          ),
        ],
  ...
  but(BuildContext context){
    return ElevatedButton(
      child: txt('Confirmar', 40, Colors.white, FontWeight.normal),
